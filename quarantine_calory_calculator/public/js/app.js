...
__webpack_require__(/*! ./join */ "./resources/js/join.js");

__webpack_require__(/*! ./open-profile */ "./resources/js/open-profile.js");

__webpack_require__(/*! ./profile-house */ "./resources/js/profile-house.js");

__webpack_require__(/*! ./profile-nutritien */ "./resources/js/profile-nutritien.js");

__webpack_require__(/*! ./profile-personal */ "./resources/js/profile-personal.js");

__webpack_require__(/*! ./profile-sport */ "./resources/js/profile-sport.js");

__webpack_require__(/*! ./recipe */ "./resources/js/recipe.js");

__webpack_require__(/*! ./size */ "./resources/js/size.js");
...
var isNutin;
var isNewRecipe = false; //Nutritien intake site
...
$(document).ready(function () {
  $('#nutin-nav').css('font-weight', '500'); //hide-show elements
...
function nutinSiteFill() {
  ...
  nutinSugarSum = 0;
  nutinWaterSum = 0;
  todayNutin.forEach(function (value) {
    $('#nutritien-intake-tbody').append($('<tr>').append($('<td>').text(value.name)).append($('<td>').text(value.calories).attr('class', 'td-center td-cal-nutin')).append($('<td>').text(value.protein).attr('class', 'td-center td-protein-nutin')).append($('<td>').text(value.carbs).attr('class', 'td-center td-carbs-nutin')).append($('<td>').text(value.sugar).attr('class', 'td-center td-sugar-nutin')).append($('<td>').text(value.fiber).attr('class', 'td-center td-fiber-nutin')).append($('<td>').text(value.fat).attr('class', 'td-center td-fat-nutin')).append($('<td>').text(value.water).attr('class', 'td-center td-water-nutin')));
  ...
  $('#total-water-nutin').text(nutinWaterSum); //fill ideal row
...
function houseSiteFill() {
  ...
  houseProteinSum = 0;
  houseSugarSum = 0;
  householdStock.forEach(function (value) {
    $('#household-stock-tbody').append($('<tr>').attr('id', value.name).append($('<td>').text(value.name).attr('class', 'td-name-house')).append($('<td>').text(value.protein * 4 + value.carbs * 4 + value.fat * 9).attr('class', 'td-center td-cal-house')).append($('<td>').text(value.protein).attr('class', 'td-center td-protein-house')).append($('<td>').text(value.carbs).attr('class', 'td-center td-carbs-house')).append($('<td>').text(value.sugar).attr('class', 'td-center td-sugar-house')).append($('<td>').text(value.fiber).attr('class', 'td-center td-fiber-house')).append($('<td>').text(value.fat).attr('class', 'td-center td-fat-house')).append($('<td>').text(value.amount).attr('class', 'td-right td-amount-house')).append($('<td>').text(value.unit).attr('class', 'td-left td-unit-house')));
  ...
  $('#total-fat-house').text(houseFatSum); //fill ideal row

  $('#minimum-cal-house').text(houseMinCal); //buttons to hide
...
function sportSiteFill() {
  sportCalSum = 0;
  sportDurationSum = 0;
  todaySport.forEach(function (value) {
    $('#sport-tbody').append($('<tr>').append($('<td>').text(value.name)).append($('<td>').text(value.calories).attr('class', 'td-center td-cal-sport')).append($('<td>').text(value.duration).attr('class', 'td-center td-duration-sport')));
...
$(document).on('click', '#house-nav', function () {
  ...
  $('#personal-nav').css('font-weight', 'normal'); //sites to hide & show

  $(".nutritien-intake").hide();
  $(".household-stock").show();
  $(".sport").hide();
  $(".personal").hide(); //alerts

  $('.row.alert-row-nutin').hide();
  $('.row.alert-row-nutin-water').hide();
  $('.row.alert-row-sport').hide();
  compareTotalAndMinimumHouse();
  isNutin = false; //count sums
...
$(document).on('click', '.th-add-new-food-house', function () {
  houseIsFood = true;
  $('#household-stock-tbody').append($('<tr>').attr('id', 'food-tr-house').append($('<td>').attr('colspan', '2').append($('<select>').attr('class', 'form-control form-control-sm').attr('id', 'food-select-house').prop('required', 'true'))).append($('<td>').attr('colspan', '2').append($('<div>').attr('class', 'input-group input-group-sm').append($('<input>').attr('type', 'number').attr('class', 'form-control').attr('placeholder', 'Amount in gramms').attr('id', 'input-value-g-house').prop('required', 'true')).append($('<div>').attr('class', 'input-group-append').append($('<span>').attr('class', 'input-group-text').text('g'))))).append($('<td>')).append($('<td>')).append($('<td>')).append($('<td>')));
  fillFoodSelectHouse();
...
function fillFoodSelectHouse() {
  ...
  foods.forEach(function (value) {
    $("#food-select-house").append($('<option>').attr('value', value.name).text(value.name));
  });
  $("#food-select-house").append($('<option>').attr('id', 'add-new-food-option').text('Add new food'));
...
$(document).on('click', '.th-add-new-drink-house', function () {
  houseIsFood = false;
  $('#household-stock-tbody').append($('<tr>').attr('id', 'drink-tr-house').append($('<td>').attr('colspan', '2').append($('<select>').attr('class', 'form-control form-control-sm').attr('id', 'drink-select-house').prop('required', 'true'))).append($('<td>').attr('colspan', '2').append($('<div>').attr('class', 'input-group input-group-sm').append($('<input>').attr('type', 'number').attr('class', 'form-control').attr('placeholder', 'Amount in ml').attr('id', 'input-value-ml-house').prop('required', 'true')).append($('<div>').attr('class', 'input-group-append').append($('<span>').attr('class', 'input-group-text').text('ml'))))).append($('<td>')).append($('<td>')).append($('<td>')).append($('<td>')));
...
function fillDrinkSelectHouse() {
  ...
  drinks.forEach(function (value) {
    $("#drink-select-house").append($('<option>').attr('value', value.name).text(value.name));
  });
  $("#drink-select-house").append($('<option>').attr('id', 'add-new-drink-option').text('Add new drink'));
...
$(document).on('click', '.th-save-house', function () {
  ...
  if (!$('#food-select-house').val() && !$('#drink-select-house').val() || !$('#input-value-g-house').val() && !$('#input-value-ml-house').val()) {
    alert("You have to fill every box.");
      ...
      var houseIsExists = false; //if the nutritien is already in the household stock
      ...
      $("#household-stock-tbody tr").each(function () {
        if ($(this).attr("id") == houseInputValueName) {
          ...
          householdStock.forEach(function (element) {
      ...
      if (!houseIsExists) {
        $('#household-stock-tbody').append($('<tr>').attr('id', houseInputValueName).append($('<td>').text(houseInputValueName).attr('class', 'td-name-house')).append($('<td>').text(houseCalAmount).attr('class', 'td-center td-cal-house')).append($('<td>').text(houseProteinAmount).attr('class', 'td-center td-protein-house')).append($('<td>').text(houseCarbsAmount).attr('class', 'td-center td-carbs-house')).append($('<td>').text(houseSugarAmount).attr('class', 'td-center td-sugar-house')).append($('<td>').text(houseFiberAmount).attr('class', 'td-center td-fiber-house')).append($('<td>').text(houseFatAmount).attr('class', 'td-center td-fat-house')).append($('<td>').text(houseAmount).attr('class', 'td-right td-amount-house')).append($('<td>').text(houseUnit).attr('class', 'td-left td-unit-house')));
      ...
      houseSugarSum += houseSugarAmount; //fill total row
      ...
      $('#total-sugar-house').text(houseSugarSum);
      $('#total-fiber-house').text(houseFiberSum);
      $('#total-fat-house').text(houseFatSum); //buttons
...
/***/ "./resources/js/profile-nutritien.js":
/*!*******************************************!*\
  !*** ./resources/js/profile-nutritien.js ***!
  \*******************************************/
/*! no static exports found */
...
$(document).on('click', '#nutin-nav', function () {
  ...
  $('#nutin-nav').css('font-weight', '500'); //buttons

  $(".th-save-cancel").hide(); //sites hide&show
...
$(document).on('click', '.th-add-new-recipe-nutin', function () {
  ...
  $('#nutritien-intake-tbody').append($('<tr>').attr('id', 'recipe-tr-nutin').append($('<td>').attr('colspan', '2').append($('<select>').attr('class', 'form-control form-control-sm').attr('id', 'recipe-select').prop('required', 'true'))).append($('<td>').attr('colspan', '2').append($('<div>').attr('class', 'input-group input-group-sm').append($('<input>').attr('type', 'number').attr('class', 'form-control').attr('placeholder', 'Amount in gramms').attr('id', 'input-value-g').prop('required', 'true')).append($('<div>').attr('class', 'input-group-append').append($('<span>').attr('class', 'input-group-text').text('g'))))).append($('<td>')).append($('<td>')).append($('<td>')).append($('<td>')));
  fillRecipeSelect();
...
function fillRecipeSelect() {
  ...
  recipes.forEach(function (value) {
    $("#recipe-select").append($('<option>').attr('value', value.name).text(value.name));
  });
  $("#recipe-select").append($('<option>').attr('id', 'add-new-recipe-option').text('Add new recipe'));
...
$(document).on('click', '.add-new-recipe-save', function () {
  ...
  if (!nutinIsFilled) {
    ...
    var nutinIsNotExists = true;
    var nutinNewRecipe = {};
    var nutinIngredients = [];
    ...
    if (nutinIsNotExists) {
      ...
      nutinIngredients.forEach(function (value) {
      ...
      $('#steps-list textarea').each(function () {
        ...
        var desc = $(this).val().trim().charAt(0).toUpperCase() + $(this).val().trim().slice(1);
...
$(document).on('click', '.th-add-new-food-recipe', function () {
  $('#ingredient-table-tbody').append($('<tr>').append($('<td>').append($('<select>').attr('class', 'form-control form-control-sm recipe-ingredient-select food-select').prop('required', true))).append($('<td>').append($('<div>').attr('class', 'input-group input-group-sm').append($('<input>').attr('type', 'number').attr('class', 'form-control recipe-ingredient-amount').attr('placeholder', 'Amount in gramms').prop('required', true)).append($('<div>').attr('class', 'input-group-append').append($('<span>').attr('class', 'input-group-text recipe-ingredient-unit').text('g'))))));
  $(".food-select").last().empty();
  $(".food-select").last().append('<option value="" disabled selected hidden>Select the food</option>');
  foods.forEach(function (value) {
    $(".food-select").last().append($('<option>').attr('value', value.name).text(value.name));
  });
  $(".food-select").last().append($('<option>').attr('class', 'add-new-food-option').attr('value', '').text('Add new food'));
}); //new drink ingredient

$(document).on('click', '.th-add-new-drink-recipe', function () {
  $('#ingredient-table-tbody').append($('<tr>').append($('<td>').append($('<select>').attr('class', 'form-control form-control-sm recipe-ingredient-select drink-select').prop('required', true))).append($('<td>').append($('<div>').attr('class', 'input-group input-group-sm').append($('<input>').attr('type', 'number').attr('class', 'form-control recipe-ingredient-amount').attr('placeholder', 'Amount in gramms').prop('required', true)).append($('<div>').attr('class', 'input-group-append').append($('<span>').attr('class', 'input-group-text recipe-ingredient-unit').text('ml'))))));
  $(".drink-select").last().empty();
  $(".drink-select").last().append('<option value="" disabled selected hidden>Select the drink</option>');
  drinks.forEach(function (value) {
    $(".drink-select").last().append($('<option>').attr('value', value.name).text(value.name));
  });
  $(".drink-select").last().append($('<option>').attr('class', 'add-new-drink-option').attr('value', '').text('Add new drink'));
}); //new step
...
$(document).on('click', '.th-add-new-food-nutin', function () {
  ...
  $('#nutritien-intake-tbody').append($('<tr>').attr('id', 'food-tr-nutin').append($('<td>').attr('colspan', '2').append($('<select>').attr('class', 'form-control form-control-sm food-select').prop('required', 'true'))).append($('<td>').attr('colspan', '2').append($('<div>').attr('class', 'input-group input-group-sm').append($('<input>').attr('type', 'number').attr('class', 'form-control').attr('placeholder', 'Amount in gramms').attr('id', 'input-value-g').prop('required', 'true')).append($('<div>').attr('class', 'input-group-append').append($('<span>').attr('class', 'input-group-text').text('g'))))).append($('<td>')).append($('<td>')).append($('<td>')).append($('<td>')));
  fillFoodSelect();
  $(".th-add-new-nutin").hide();
  $(".th-save-cancel-nutin").show();
}); //fill select with the options
...
function fillFoodSelect() {
  $('.food-select').each(function () {
    ...
    foods.forEach(function (value) {
      $(_this).append($('<option>').attr('value', value.name).text(value.name));
    });
    $(this).append($('<option>').attr('class', 'add-new-food-option').attr('value', '').text('Add new food'));
  });
} //when select add new food
...
$(document).on('click', '.th-add-new-drink-nutin', function () {
  ...
  $('#nutritien-intake-tbody').append($('<tr>').attr('id', 'drink-tr-nutin').append($('<td>').attr('colspan', '2').append($('<select>').attr('class', 'form-control form-control-sm drink-select').prop('required', 'true'))).append($('<td>').attr('colspan', '2').append($('<div>').attr('class', 'input-group input-group-sm').append($('<input>').attr('type', 'number').attr('class', 'form-control').attr('placeholder', 'Amount in ml').attr('id', 'input-value-ml').prop('required', 'true')).append($('<div>').attr('class', 'input-group-append').append($('<span>').attr('class', 'input-group-text').text('ml'))))).append($('<td>')).append($('<td>')).append($('<td>')).append($('<td>')));
  fillDrinkSelect();
  $(".th-add-new-nutin").hide();
  $(".th-save-cancel-nutin").show();
}); //fill select with the options
...
function fillDrinkSelect() {
  $('.drink-select').each(function () {
    ...
    drinks.forEach(function (value) {
      $(_this2).append($('<option>').attr('value', value.name).text(value.name));
    });
    $(this).append($('<option>').attr('class', 'add-new-drink-option').attr('value', '').text('Add new drink'));
  });
} //when select add new drink
...
$(document).on('click', '.th-save-nutin', function () {
  if (!$('.food-select').val() && !$('.drink-select').val() && !$('#recipe-select').val() || !$('#input-value-g').val() && !$('#input-value-ml').val()) {
    ...
    nutinCalAmount = nutinProteinAmount * 4 + nutinCarbsAmount * 4 + nutinFatAmount * 9; //update sum
    ...
    $('#total-water-nutin').text(nutinWaterSum); //new table row

    $('#nutritien-intake-tbody').append($('<tr>').append($('<td>').text(nutinInputValueName)).append($('<td>').text(nutinCalAmount).attr('class', 'td-center td-cal-nutin')).append($('<td>').text(nutinProteinAmount).attr('class', 'td-center td-protein-nutin')).append($('<td>').text(nutinCarbsAmount).attr('class', 'td-center td-carbs-nutin')).append($('<td>').text(nutinSugarAmount).attr('class', 'td-center td-sugar-nutin')).append($('<td>').text(nutinFiberAmount).attr('class', 'td-center td-fiber-nutin')).append($('<td>').text(nutinFatAmount).attr('class', 'td-center td-fat-nutin')).append($('<td>').text(nutinWaterAmount).attr('class', 'td-center td-water-nutin'))); //add new nutin

    todayNutin.unshift(newNutin); //delete from household
    ...
    $("#household-stock-tbody tr").each(function () {
      if ($(this).attr("id") == nutinInputValueName && nutinChoosed != nutinIs[0]) {
        if (parseFloat($("#" + nutinInputValueName + " .td-amount-house").text()) - nutinAmount > 0) {
          var houseCalAmount = parseFloat($("#" + nutinInputValueName + " .td-cal-house").text());
          $("#" + nutinInputValueName + " .td-cal-house").text(houseCalAmount - nutinCalAmount);
          var houseProteinAmount = parseFloat($("#" + nutinInputValueName + " .td-protein-house").text());
          $("#" + nutinInputValueName + " .td-protein-house").text(houseProteinAmount - nutinProteinAmount);
          var houseCarbsAmount = parseFloat($("#" + nutinInputValueName + " .td-carbs-house").text());
          $("#" + nutinInputValueName + " .td-carbs-house").text(houseCarbsAmount - nutinCarbsAmount);
          var houseFiberAmount = parseFloat($("#" + nutinInputValueName + " .td-fiber-house").text());
          $("#" + nutinInputValueName + " .td-fiber-house").text(houseFiberAmount - nutinFiberAmount);
          var houseSugarAmount = parseFloat($("#" + nutinInputValueName + " .td-sugar-house").text());
          $("#" + nutinInputValueName + " .td-sugar-house").text(houseSugarAmount - nutinSugarAmount);
          var houseFatAmount = parseFloat($("#" + nutinInputValueName + " .td-fat-house").text());
          $("#" + nutinInputValueName + " .td-fat-house").text(houseFatAmount - nutinFatAmount);
          var houseAmount = parseFloat($("#" + nutinInputValueName + " .td-amount-house").text());
    ...
    if (nutinChoosed == nutinIs[0]) {
      ...
      recipes.forEach(function (value) {
        if (value.name == nutinInputValueName) {
          value.ingredients.split("#!#").forEach(function (value) {
            ...
            $("#household-stock-tbody tr").each(function () {
              if (element[0] == $(this).attr("id")) {
                ...
                if (parseFloat($("#" + element[0] + " .td-amount-house").text()) - nutinAmount > 0) {
                  ...
                  var houseCalAmount = parseFloat($("#" + element[0] + " .td-cal-house").text());
                  $("#" + element[0] + " .td-cal-house").text(houseCalAmount - nutinCalAmount);
                  var houseProteinAmount = parseFloat($("#" + element[0] + " .td-protein-house").text());
                  $("#" + element[0] + " .td-protein-house").text(houseProteinAmount - nutinProteinAmount);
                  var houseCarbsAmount = parseFloat($("#" + element[0] + " .td-carbs-house").text());
                  $("#" + element[0] + " .td-carbs-house").text(houseCarbsAmount - nutinCarbsAmount);
                  var houseFiberAmount = parseFloat($("#" + element[0] + " .td-fiber-house").text());
                  $("#" + element[0] + " .td-fiber-house").text(houseFiberAmount - nutinFiberAmount);
                  var houseSugarAmount = parseFloat($("#" + element[0] + " .td-sugar-house").text());
                  $("#" + element[0] + " .td-sugar-house").text(houseSugarAmount - nutinSugarAmount);
                  var houseFatAmount = parseFloat($("#" + element[0] + " .td-fat-house").text());
                  $("#" + element[0] + " .td-fat-house").text(houseFatAmount - nutinFatAmount);
                  var houseAmount = parseFloat($("#" + element[0] + " .td-amount-house").text());
    ...
    $(".th-save-cancel-nutin").hide(); //compare
...
/***/ "./resources/js/profile-personal.js":
/*!******************************************!*\
  !*** ./resources/js/profile-personal.js ***!
  \******************************************/
/*! no static exports found */
...
$(document).on('click', '#personal-nav', function () {
  ...
  $('.row.alert-row-nutin').hide();
  $('.row.alert-row-house').hide();
  $('.row.alert-row-sport').hide(); //fill data

  fillData(); //hide-show elements
...
$(document).on('click', '#personal-edit-btn', function () {
  ...
  $('#personal-household-edit-input').attr('value', personalHousehold); //buttons
...
$(document).on('click', '#personal-save-btn', function () {
  if (isDataEdit) {
    ...
    personalHousehold = $('#personal-household-edit-input').val(); //fill data
...
$(document).on('click', '#sport-nav', function () {
  ...
  $('#house-nav').css('font-weight', 'normal');
  $('#nutin-nav').css('font-weight', 'normal');
  $('#personal-nav').css('font-weight', 'normal'); //sites hide&show
  ...
  $('.row.alert-row-nutin').hide();
  $('.row.alert-row-nutin-water').hide();
  $('.row.alert-row-house').hide(); //buttons

  $(".th-add-new-sport").show();
  $(".th-save-cancel-sport").hide(); //compare

  compareTotalAndIdealSport();
}); //add new sport activity

$(document).on('click', '.th-add-new-sport-btn', function () {
  $('#sport-tbody').append($('<tr>').attr('id', 'tr-new-sport').append($('<td>').attr('colspan', '2').append($('<select>').attr('class', 'form-control form-control-sm').attr('id', 'sport-select').prop('required', true))).append($('<td>').append($('<div>').attr('class', 'input-group input-group-sm').append($('<input>').attr('type', 'number').attr('class', 'form-control').attr('placeholder', 'Duration in mins').attr('id', 'input-value-mins').prop('required', true)).append($('<div>').attr('class', 'input-group-append').append($('<span>').attr('class', 'input-group-text').text('mins'))))));
  fillSportSelect();
...
$(document).on('click', '.th-save-sport', function () {
  if (!$('#sport-select option:selected').val() || !$('#input-value-mins').val()) {
    ...
    var sportInputValueName = $('#sport-select option:selected').text();
    ...
    var sportDuration = parseFloat($('#input-value-mins').val());
    $('#sport-tbody').find('#tr-new-sport').remove();
    var sportCalAmount = sportDuration / 60 * sportSelected.calories;
    $('#sport-tbody').append($('<tr>').append($('<td>').text(sportInputValueName)).append($('<td>').text(sportCalAmount).attr('class', 'td-center td-cal-sport')).append($('<td>').text(sportDuration).attr('class', 'td-center td-duration-sport')));
    var sportNewToday = {};
    sportNewToday.name = sportInputValueName;
    sportNewToday.calories = sportCalAmount;
    sportNewToday.duration = sportDuration;
    todaySport.push(sportNewToday); //count sum

    sportCalSum += sportCalAmount;
    $('#total-cal-sport').html(sportCalSum);
    sportDurationSum += sportDuration;
    $('#total-duration').html(sportDurationSum); //buttons
...
function fillSportSelect() {
  ...
  sports.forEach(function (value) {
    $("#sport-select").append($('<option>').attr('value', value.name).text(value.name));
  });
  $("#sport-select").append($('<option>').attr('id', 'add-new-sport-option').text('Add new sport'));
}
...
function fillAllRecipes() {
  ...
  recipes.forEach(function (value) {
    if (num % 3 == 0) {
      $('#recipes-site-content').append($('<div>').attr('class', 'row recipe-card'));
    }

    $('#recipes-site-content .recipe-card').last().append($('<div>').attr('class', 'col-md-4 align-items-center').append($('<div>').attr('class', 'card recipe-box').append($('<button>').attr('class', 'card-link btn recipe-card-link').attr('data-toggle', 'modal').attr('data-target', '#open-recipe-modal').attr('id', value.name).text(value.name))));
    num++;
  });
}
...
$(document).on('click', '.recipe-card-link', function () {
  ...
  recipes.forEach(function (value) {
    if (value.name == $(_this).text()) {
      ...
      value.ingredients.split("#!#").forEach(function (element) {
  ...
  openRecipe.ingredients.forEach(function (value) {
    $('#open-recipe-tbody').append($('<tr>').append($('<td>').text(value[0])).append($('<td>').text(value[1] + " " + value[2])));
  });
  $('#open-recipe-steps').empty();
  openRecipe.description.forEach(function (value) {
    $('#open-recipe-steps').append($('<li>').text(value));
  });
}); //when select add new recipe
...
function fillDrinkSelect() {
  $('.drink-select').each(function () {
    ...
    $(this).append('<option value="" disabled selected hidden>Select the drink</option>');
    drinks.forEach(function (value) {
      $(_this3).append($('<option>').attr('value', value.name).text(value.name));
    });
    $(this).append($('<option>').attr('class', 'add-new-drink-option').attr('value', '').text('Add new drink'));
  });
} //when select add new drink
...
$(window).ready(function () {
  if (lastWidth < 992) {
    for (var _i = 0; _i < navText.length; _i++) {
      navText.item(_i).style.display = "none";
    }
  } else {
...
$(window).resize(function () {
  if ($(window).width() != lastWidth) {
    ...
    if (lastWidth < 992) {
      for (var _i2 = 0; _i2 < navText.length; _i2++) {
        navText.item(_i2).style.display = "none";
      }
    } else {
      for (var i = 0; i < navText.length; i++) {
        navText.item(i).style.display = "inline";
...
__webpack_require__(/*! C:\Users\Andras\Documents\quarantine_calory_calculator\quarantine_calory_calculator\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Andras\Documents\quarantine_calory_calculator\quarantine_calory_calculator\resources\css\app.css */"./resources/css/app.css");
