        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <form action="{{route('nutrition.ingredients.store')}}" method="post">
                    ...
                    <div class="form-group">
                        <label class="form-label" style="display: block; text-align: center"
                               for="recipe">INGREDIENT</label>
                        <select class="form-control select-food @error("food") is-invalid @enderror()" name="food"
                                id="food">
                    ...
                    <div class="form-group">
                        @if(\App\Models\Food::first()->type == "food")
                            ...
                            <label class="form-label unit-label" style="display: block; text-align: center"
                                   for="weight">AMOUNT (g)</label>
                        @else
                            <label class="form-label unit-label" style="display: block; text-align: center"
                                   for="weight">AMOUNT (ml)</label>
                        @endif
                    ...
                    <div style="display: block; text-align: left"><input class="btn btn-primary " type="submit"
                                                                         value="Save"></div>
            ...
            <div class="col">
                ...
                <form action="{{route('nutrition.store')}}" method="post">
                    ...
                    <div class="form-group">
                        <label class="form-label" style="display: block; text-align: center" for="weight">AMOUNT
                            (g)</label>
                        <input class="form-control @error("weight") is-invalid @enderror()" name="weight" id="weight"
                               type="number"></input>
                        @error("weight")
